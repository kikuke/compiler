...
initializer_list
    : initializer {$$=makeNode(N_INIT_LIST, $1, NIL, makeNode(N_ARG_LIST_NIL, NIL, NIL, NIL));}
...
struct_type_specifier
    : struct_or_union IDENTIFIER {$$=setTypeStructOrEnumIdentifier($1, $2, ID_STRUCT);} LR {$$=current_id; current_level++;} struct_declaration_list RR {checkForwardReference(); $$=setTypeField($3, $6); current_level--; current_level=$5;}
    ...
    | struct_or_union IDENTIFIER {$$=getTypeOfStructOrEnumReIdentifier($1, $2, ID_STRUCT);}
    ;
...
enum_type_specifier
    ...
    | ENUM_SYM IDENTIFIER {$$=getTypeOfStructOrEnumReIdentifier(T_ENUM, $2, ID_ENUM);}
    ;
...
cast_expression
    : unary_expression {$$=$1;}
    | LP type_name RP cast_expression {$$=makeNode(N_EXP_CAST, $1, NIL, $3);}
    ;
